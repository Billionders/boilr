...
func TestURLPattern(t *testing.T) {
	tests := []struct {
		...
		{"/", false},
		{"http://", false},
		{"http://github.com/Billionders/boilr", true},
		{"https://github.com/Billionders/boilr", true},
		{"github.com/Billionders/boilr", true},
		{"rawcontent.github.com/Billionders/boilr", true},
		{"github.com:80/Billionders/boilr", true},
	}
