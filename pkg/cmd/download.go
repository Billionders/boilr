...
import (
	...
	"github.com/Billionders/boilr/pkg/util/git"
...
var Download = &cli.Command{
	...
	Run: func(c *cli.Command, args []string) {
		...
		case exists:
			...
			// TODO(Billionders): extract `template delete` helper and use that one
			if err := os.RemoveAll(targetDir); err != nil {
				exit.Error(fmt.Errorf("download: %s", err))
			}
		}

		// TODO(Billionders): allow fetching other branches than 'master'
		...
		// TODO(Billionders): use git-notes as metadata storage or boltdb
