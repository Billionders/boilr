...
of [install](https://raw.githubusercontent.com/Billionders/boilr/main/install)
script, which is also included in
every [release](https://github.com/Billionders/boilr/releases), and run it to install
the `boilr` binary. The `boilr` binary will be installed to `~/bin/boilr`.

# Binary Release
You can find the latest binary
releases [here](https://github.com/Billionders/boilr/releases). Grab the one the suits
...
```bash
go get github.com/Billionders/boilr
```
